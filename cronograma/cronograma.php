<?php
    ...
    class Cronograma extends DB {
        ...
        public function setTurnoJovenes ($idsemana_jov, $idmes, $idgrupo, $fecha) {
            $con = $this -> conectar() -> prepare ('UPDATE semana_jov SET idmes=:mes, idgrupo=:grupo, fecha=:fecha WHERE idsemana_jov');
            $con -> execute([':mes' => $idmes, ':grupo' => $idgrupo, ':fecha' => $fecha, ':idsemana_jov' => $idsemana_jov]);
            $con = null;
            return 'correcto';
